...
record FanData "Fan data for the validation model"
  extends Buildings.Fluid.Movers.Data.Generic(
    ...
    power(
      V_flow={0, 0.042691, 0.085382, 0.128073, 0.170764, 0.213455,
              0.256146, 0.298837, 0.341528, 0.384219, 0.42691},
      P={4.510, 6.747, 8.782, 11.002, 13.794, 17.548,
         22.650, 29.489, 38.451, 49.926, 64.300}),
    pressure(
      V_flow={0.042691, 0.085382, 0.128073, 0.170764, 0.213455,
              0.256146, 0.298837, 0.341528, 0.384219, 0.42691},
